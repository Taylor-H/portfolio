  ...
  projects: [
    {
      ...
      description: `My. My portfolio app allows you to view my projects and see a brief description of each. It has a messaging feature that I set up using emailJS. I've separated the information from the app itself. When I get more projects up I will add a database. It has categories that allow you to filter through the projects. I set up front end routing with React Router.`,
    ...
    },
    {
      ...
      title: 'Pixelate',
      tagLine:
        'A pixel art tool that allows the user to click blocks to make art.',
      tech: ['React', 'JavaScript', 'html5', 'css3', 'Git', 'Heroku'],
      role: ['Game Developer', 'UI/UX Design', 'Graphic Design'],
      description: `I originally made Pixel when learning Javascript. When learning to use React I thought it would be interesting to refactor it into a React app. I plan to add a feature that allows the user to upload a background image to trace over and export as .png as a fun way to make a custom pixelated profile picture. I put the original plain javascript code in a separate branch on github.`,
      links: {
        gitHub: 'https://github.com/Taylor-H/pixelclick',
...
`,
    ...
    },
    {
      ...
      design: ` This site is an example of what I call Creative Development. Designing the graphics as needed. I used CSS grid and Flex-box to create a responsive design. I used media queries to adjust the site to according to screen width. `,
      links: {
