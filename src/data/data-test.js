const data = {
  ...
  projects: [
    ...
    },
    {
      ...
      role: ['Developer'],
      description:
        'I recreated a javascript classic. Click the coffee or let time pass to get coffee points. Invest in ever larger containers to grow your coffee rate. There is also tests in the repo to see if I accomplished my goals',
      links: {
        gitHub: 'https://github.com/Taylor-H/coffee-clicker',
        live: '/projects/coffee-clicker',
      },
      images: { prevImg: 'coffee-clicker.png' },
      categories: ['game'],
      featured: true,
    },
    {
    ...
    },
    {
      ...
      images: { prevImg: 'medFlow-big.png' },
      categories: ['app'],
    },
    {
      id: 22,
    ...
    },
    {
      ...
      images: { prevImg: 'monument_desktop', styleGuide: 'styleguide_medium.png' },
      categories: ['app'],
    },
  ],
};
