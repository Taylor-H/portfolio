const data = {
  ...
  projects: [
    ...
    },
    {
      ...
      design: `I played a leading role in planning the database schema and setting up API/Frontend routes.`,
      features: [
        'Authentication',
        'Persistent Questions and Answers',
        'Demo User',
        'GitHub Wiki',
        'Voting',
      ],
