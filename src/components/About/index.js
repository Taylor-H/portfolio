        ...
        <li className="flex-item one">
          <div id="para">
            ...
            <p id="summary-text">
              ...
              over the country get connected to the World Wild Web. It wasn't
              long before I moved to supporting our commercial and corporate web
              hosting clients. That's where I learned to make web sites that
              were more than static pages.
            </p>
          </div>
        </li>
        <li className="flex-item one">
          ...
          <div id="para">
            <p id="summary-text">
              ...
              <a href="https://en.wikipedia.org/wiki/RioPort">
                "the first internet music service (cloud service) to legally
                offer digital songs from all the major music labels".
              </a>{' '}
              The precursor to{' '}
              <a
                ...
                iTunes *
              </a>{' '} among others. I had quickly become a Front End guru primarily
              integrating graphics, data, and code for the web browser. I
              enjoyed a successful and rewarding career until 2005 when I took
              some time off to start a family. Time kept doing what time does
              and due to circumstances I was not able to continue my career for
              a very long time.
            </p>
          </div>
        </li>
        <li className="flex-item one">
          <div className="creative" id="para">
            ...
            <p id="summary-text">
              ...
              into coming back to my previous occupation. The advent of hand
              held devices like tablets and phones, social media, streaming
              platforms had all come about in the time I was away. I wanted to
              get back to building websites and web applications but I really
              didn't know where to start. I turned to General Assembly in
              Boston. I was able to refresh my HTML and CSS skills and I was
        ...
        <li className="flex-item one">
          <div className="creative" id="para">
            ...
            <p id="summary-text">
              ...
              that experience are certainly still relevant. Working on a team
              and being able to translate technical concepts to non technical
              team mates is always going to be a useful skill. I may have had to
              learn a lot of new technologies to be able to make modern web apps
              but it was so worth it. It's a great feeling to be able to create
              something that actually does something. Something that improves
              peoples lives and helps them to achieve their goals. It's a great
              feeling to be able to say I'm a Full Stack Software developer.
            </p>
          </div>
        </li>
        <li className="flex-item one">
